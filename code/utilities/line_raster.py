...
if __name__ == '__main__':
    ...
    Taxi_NYC = gpd.GeoDataFrame(geometry=[LineString([(start_lon, start_lat), (end_lon, end_lat)]) 
                                      for start_lon, start_lat, end_lon, end_lat 
                                      in zip(Taxi_NYC['Pickup_longitude'], Taxi_NYC['Pickup_latitude'],
                                             Taxi_NYC['Dropoff_longitude'], Taxi_NYC['Dropoff_latitude'])])
    print(Taxi_NYC)
    ...
    Taxi_NYC_raster.rio.to_raster(r'C:\Users\aslam\Desktop\foundation_of_data\foundation of data science\output_Taxi_NYC.tiff')
